...
public class EquipoFutbol extends EquipoLibre{

     private  String numeroDeIntegrante="11";

    public String getNumeroDeIntegrante() {
        return numeroDeIntegrante;
    }

    public EquipoFutbol(String nombre, String horario, String requisitos,String tipo) {
